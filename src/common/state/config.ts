 ...
 */
export const useNamespacedConfigs = (namespace: string = "") => {
 ...
 */
export const useNamespacedCurrentConfigId = (namespace: string = "") => {
 ...
 */
export const useNamespacedConfigLock = (configId: string, namespace: string = "") => {
	// 針對每個帳號 ID 獨立鎖定
 ...
 */
export const updateLastUsedConfigId = (id: string, namespace: string = "") => {
	const lKey = namespace ? `${LAST_USED_CONFIG_KEY}_${namespace}` : LAST_USED_CONFIG_KEY;
