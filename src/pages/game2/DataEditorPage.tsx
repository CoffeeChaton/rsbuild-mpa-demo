...
import {
    CopyIcon, TrashIcon, StarFilledIcon
                        ...
                        <TableBody>
                            {displayData.map((row, idx) => (
                                <TableRow key={row.id}>
                                    ...
                                    <TableCell>
                                        <input list="item-options" className="bg-transparent outline-none text-xs font-black w-full" value={row.product} onChange={e => {
                                            const newRows = [...rows];
                                    ...
                                    <TableCell className="text-right">
                                        <input type="number" className="w-full bg-transparent text-right font-mono text-xs font-black text-blue-600 outline-none" value={row.amount} onChange={e => {
                                            const newRows = [...rows];
