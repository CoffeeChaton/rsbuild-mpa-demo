...
describe("validateLevel 邏輯測試", () => {
	describe("配置數據應該正確", () => {
		it("LV_MAX_MAP 數據應該正確", { timeout: 10000 }, () => {
